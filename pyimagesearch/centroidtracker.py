    ...
    def update(self, rects):
        ...
        if len(rects) == 0:
            ...
            for objectID in list(self.disappeared.keys()):
                ...
                # where a given object has been marked as missing then deregister it
        ...
        # loop over the bounding box rectangles and
        ...
        # take the input centroids and register each of them
        if len(self.objects) == 0:
            for i in range(0, len(inputCentroids)):
                self.register(inputCentroids[i])

        # otherwise, they are currently tracking objects so we need to
        # try match the input centroids to existing object centroids
        else:
            ...
            # with the smallest value be at the *front* of the index list
            ...
            # the number of input centroids we need to check and see if
            # some of these objects have potentially disappeared
            if D.shape[0] >= D.shape[1]:
                ...
                for row in unusedRows:
                    ...
                    # check to see if the number of consecutive frames the object has been
                    # marked "disappeared" for warrants deregistering the object
                    if self.disappeared[objectID] > self.maxDisappeared:
                        self.deregister(objectID)
